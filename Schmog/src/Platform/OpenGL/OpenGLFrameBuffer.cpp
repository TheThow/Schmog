...
namespace Schmog {
	...
	void OpenGLFrameBuffer::Invalidate()
	{
		...
		glTexStorage2D(GL_TEXTURE_2D, 0, GL_DEPTH24_STENCIL8, m_FrameBufferSpec.Width, m_FrameBufferSpec.Height);
		...
		SG_CORE_ASSERT(glCheckFramebufferStatus(GL_FRAMEBUFFER) == GL_FRAMEBUFFER_COMPLETE, "Framebuffer incomplete");
